...
bool operator==(const ::trajectory_msgs::MultiDOFJointTrajectory_<ContainerAllocator1> & lhs, const ::trajectory_msgs::MultiDOFJointTrajectory_<ContainerAllocator2> & rhs)
{
