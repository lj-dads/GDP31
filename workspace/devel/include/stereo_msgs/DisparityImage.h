...
bool operator==(const ::stereo_msgs::DisparityImage_<ContainerAllocator1> & lhs, const ::stereo_msgs::DisparityImage_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    ...
    lhs.min_disparity == rhs.min_disparity &&
    lhs.max_disparity == rhs.max_disparity &&
    lhs.delta_d == rhs.delta_d;
}
