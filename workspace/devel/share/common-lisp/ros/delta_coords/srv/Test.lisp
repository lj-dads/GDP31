...
(cl:in-package delta_coords-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <Test-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Test-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name delta_coords-srv:<Test-request> is deprecated: use delta_coords-srv:Test-request instead.")))

(cl:ensure-generic-function 'input-val :lambda-list '(m))
(cl:defmethod input-val ((m <Test-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader delta_coords-srv:input-val is deprecated.  Use delta_coords-srv:input instead.")
  (input m))
...
(cl:defmethod cl:initialize-instance :after ((m <Test-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Test-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name delta_coords-srv:<Test-response> is deprecated: use delta_coords-srv:Test-response instead.")))

(cl:ensure-generic-function 'output-val :lambda-list '(m))
(cl:defmethod output-val ((m <Test-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader delta_coords-srv:output-val is deprecated.  Use delta_coords-srv:output instead.")
  (output m))
