...
let SendCoordsGoal = require('./SendCoordsGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class SendCoordsActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = SendCoordsGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += SendCoordsGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SendCoordsActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = SendCoordsGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new SendCoordsGoal()
    }
...
module.exports = SendCoordsActionGoal;
