...
class AveragingActionFeedback {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = AveragingFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new AveragingActionFeedback(null);
    ...
    data.feedback = AveragingFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new AveragingActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = AveragingFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new AveragingFeedback()
    }
...
module.exports = AveragingActionFeedback;
