...
class AveragingActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = AveragingGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new AveragingActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = AveragingGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new AveragingGoal()
    }
