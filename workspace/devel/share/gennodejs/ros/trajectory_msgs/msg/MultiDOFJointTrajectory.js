...
class MultiDOFJointTrajectory {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.points.forEach((val) => {
      bufferOffset = MultiDOFJointTrajectoryPoint.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MultiDOFJointTrajectory(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.points[i] = MultiDOFJointTrajectoryPoint.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.points.forEach((val) => {
      length += MultiDOFJointTrajectoryPoint.getMessageSize(val);
    });
    return length + 8;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MultiDOFJointTrajectory(null);
    ...
    if (msg.points !== undefined) {
      ...
      for (let i = 0; i < resolved.points.length; ++i) {
        resolved.points[i] = MultiDOFJointTrajectoryPoint.Resolve(msg.points[i]);
      }
    }
    else {
      resolved.points = []
