...
class JointTrajectory {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.points.forEach((val) => {
      bufferOffset = JointTrajectoryPoint.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    for (let i = 0; i < len; ++i) {
      data.points[i] = JointTrajectoryPoint.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.points.forEach((val) => {
      length += JointTrajectoryPoint.getMessageSize(val);
    });
    return length + 8;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.points !== undefined) {
      ...
      for (let i = 0; i < resolved.points.length; ++i) {
        resolved.points[i] = JointTrajectoryPoint.Resolve(msg.points[i]);
      }
    }
    else {
      resolved.points = []
