...
class TwoIntsActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = TwoIntsGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TwoIntsActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = TwoIntsGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new TwoIntsGoal()
    }
...
module.exports = TwoIntsActionGoal;
