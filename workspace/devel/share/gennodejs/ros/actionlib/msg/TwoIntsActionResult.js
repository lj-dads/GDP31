...
class TwoIntsActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = TwoIntsResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TwoIntsActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = TwoIntsResult.Resolve(msg.result)
    }
    else {
      resolved.result = new TwoIntsResult()
    }
...
module.exports = TwoIntsActionResult;
