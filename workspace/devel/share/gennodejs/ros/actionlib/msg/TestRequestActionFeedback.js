...
class TestRequestActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = TestRequestFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TestRequestActionFeedback(null);
    ...
    data.feedback = TestRequestFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TestRequestActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = TestRequestFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new TestRequestFeedback()
    }
...
module.exports = TestRequestActionFeedback;
