...
class TwoIntsActionFeedback {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = TwoIntsFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TwoIntsActionFeedback(null);
    ...
    data.feedback = TwoIntsFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TwoIntsActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = TwoIntsFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new TwoIntsFeedback()
    }
...
module.exports = TwoIntsActionFeedback;
