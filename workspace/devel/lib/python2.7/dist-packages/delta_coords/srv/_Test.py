...
"""autogenerated by genpy from delta_coords/TestRequest.msg. Do not edit."""
import codecs
import sys
...
class TestRequest(genpy.Message):
  ...
  _type = "delta_coords/TestRequest"
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from delta_coords/TestResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class TestResponse(genpy.Message):
  ...
  _type = "delta_coords/TestResponse"
  _has_header = False  # flag to mark the presence of a Header object
