...
"""autogenerated by genpy from delta_coords/SendCoordsActionResult.msg. Do not edit."""
import codecs
import sys
...
class SendCoordsActionResult(genpy.Message):
  _md5sum = "140c1dfe3c49a7be6f1a84de5ede3893"
  _type = "delta_coords/SendCoordsActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','delta_coords/SendCoordsResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SendCoordsActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = delta_coords.msg.SendCoordsResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = delta_coords.msg.SendCoordsResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.binary_result,) = _get_struct_I().unpack(str[start:end])
      return self
